            ...
            <div className="home" id='home'>
                <div className="content">
                    <div className="wrapper" data-aos="fade-up">
                        ...
                        <h2>BcP COIN</h2>
                        <h3>The BCPB Platform is a state-of-the-art blockchain-based solution designed specifically for investors looking to invest in <span>THE REAL ESTATE "BITCOIN"</span> with a primary focus on Bitcoin transactions.</h3>
